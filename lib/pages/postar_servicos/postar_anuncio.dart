...
class PostAnounce extends StatefulWidget {
  const PostAnounce({Key? key}) : super(key: key);

  @override
  State<PostAnounce> createState() => _PostAnounceState();
}

class _PostAnounceState extends State<PostAnounce> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar(titulo: "Anuncie no Kulolesa"),
              ...
              children: <Widget>[
                ...
                Container(
                  child: TextField(
                    ...
                    maxLines: null,
                    decoration: const InputDecoration(
                      labelText: "Breve descrição do anuncio ",
                      labelStyle: TextStyle(
                        fontFamily: "",
                      ),
